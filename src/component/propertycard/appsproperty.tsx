...
const AppsProperty: React.FC<propertyProps> = ({
  bedroom = 4,
  bathroom = 3,
  type = "Villa",
}) => {
  return (
    <div className="bg-cardgray text-[14px] text-white rounded-lg shadow-md">
      <div className="grid grid-cols-6 gap-2">
        ...
        <div className="bg-cardgray-10 px-1 py-2 col-span-2 rounded-full flex items-center justify-center space-x-2">
